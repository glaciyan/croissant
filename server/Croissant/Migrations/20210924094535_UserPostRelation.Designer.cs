...
namespace Croissant.Migrations
{
    ...
    [Migration("20210924094535_UserPostRelation")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entities.Models.Post", b =>
                {
                    ...
                    b.HasIndex("PosterId")
                        .HasDatabaseName("ix_posts_poster_id");
            ...
            modelBuilder.Entity("Entities.Models.User", b =>
                {
                    ...
                    b.Property<string>("RefreshTokenVersion")
                        .HasColumnType("text")
                        .HasColumnName("refresh_token_version");
            ...
            modelBuilder.Entity("Entities.Models.Post", b =>
                {
                    b.HasOne("Entities.Models.User", "Poster")
                        .WithMany("Posts")
                        .HasForeignKey("PosterId")
                        .HasConstraintName("fk_posts_users_poster_id");
